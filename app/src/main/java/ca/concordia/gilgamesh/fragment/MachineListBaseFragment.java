...
public abstract class MachineListBaseFragment extends Fragment {
    ...
    private static final String TAG = "MachineListBaseFragment";
    ...
    public MachineListBaseFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_all_machines, container, false);

        // [START create_database_reference]
        mDatabase = FirebaseDatabase.getInstance().getReference();
        // [END create_database_reference]

        mRecycler = rootView.findViewById(R.id.machinesList);
            ...
            protected void onBindViewHolder(PostViewHolder viewHolder, int position, final Post model) {
                ...
                viewHolder.bindToPost(model, new View.OnClickListener() {
                    ...
                    public void onClick(View starView) {
                        ...
                        DatabaseReference globalPostRef = mDatabase.child("machines").child(postRef.getKey());
                        DatabaseReference userPostRef = mDatabase.child("user-machines").child(model.uid).child(postRef.getKey());
